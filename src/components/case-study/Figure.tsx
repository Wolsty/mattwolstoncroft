...
/**
 * Standard case-study figure. Click the image to open a full-viewport
 * lightbox with the full-resolution asset. Close with ESC, overlay click,
 * or the close button. Pass `zoomable={false}` to render a static image.
 */
    ...
    <>
      ...
      {open && zoomable ? (
        ...
        >
          ...
          >
            {/* Plain <img> inside the lightbox so users see the full natural
                resolution without Next's responsive sizing capping it. */}
